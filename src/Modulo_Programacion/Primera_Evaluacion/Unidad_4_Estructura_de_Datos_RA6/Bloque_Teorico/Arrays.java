...
public class Arrays {
	...
	private static void sort(String[] muchosMasProfesores) {
	...
	private static String toString(String[] muchosMasProfesores) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'toString'");
	}

	private static void fill(int[] diasDelMes, int i) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'fill'");
	}

	private static char[] binarySearch(String[] muchosMasProfesores, String string) {
		// TODO Auto-generated method stub
		throw new UnsupportedOperationException("Unimplemented method 'binarySearch'");
	}

	private static String[] copyOf(String[] profesores, int i) {
		// TODO Auto-generated method stub
