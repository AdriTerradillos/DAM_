...
public class FechasyHoras {
	public static void main(String[] args) {
		...
		// Con el objerto DateTimeFormatter lo convertimos en una cadena con el formato
		// deseado
		...
		// Podemos inicializar estos objetos con una fecha u hora concreta en lugar de
		// con la actual:
		...
		// En este caso especificamos con el objeto DateTimeFormatter el formato de la
		// cadena
		...
		// Los objetos de fecha y hora son inmutables. No se pueden modificar
		// directamente
		...
		// Si lo piensas también podemos hacerlo con DateTimeFormatter, pero siempre en
		// modo texto
